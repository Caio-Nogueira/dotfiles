...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      --
      local extended_capabilities = vim.lsp.protocol.make_client_capabilities()
      extended_capabilities.textDocument.completion.completionItem.snippetSupport = true
      extended_capabilities.textDocument.codeLens = { dynamicRegistration = true }
      extended_capabilities.textDocument.completion.completionItem.resolveSupport = {
        properties = {
          'documentation',
          'detail',
          'additionalTextEdits',
  ...
  require 'kickstart.plugins.goextras',
